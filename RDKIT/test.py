...
params = model.init_params(key)  # dummy init with same structure

# ---------------------------
# Load trained parameters
# ---------------------------

with open("RDKIT/PARAMETER/gcnn_params.pkl", "rb") as f:
...
def evaluate_model(params, test_set, num_features):
    ...
    for sample in tqdm(test_set, desc="Evaluating", ncols=100):
        ...
        print(f"Predicted: {y_pred:.4f}, True: {y:.4f}")
